...
class NativeCordieriteModule(reactContext: ReactApplicationContext) :
  NativeCordieriteSpec(reactContext) {

  private val manager = CordieriteConnectionManager(
  ...
  override fun send(message: String, promise: Promise) {
    try {
