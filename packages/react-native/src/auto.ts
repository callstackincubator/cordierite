 ...
 * installs the default deep-link bootstrap listener immediately (the v1 root-import behavior, now
 * opt-in): `import "@cordierite/react-native/auto";` once, near your app's entry point.
 *
